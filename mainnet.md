...
International visit:
```
https://node-mainnet.Darthion.io
wss://ws-mainnet.Darthion.io
```

## explorer
```
https://explorer.Darthion.org
...
> the following nodes are default config for bootstrap node in code https://github.com/Darthion/Darthion-Core/blob/main/params/bootnodes.go
